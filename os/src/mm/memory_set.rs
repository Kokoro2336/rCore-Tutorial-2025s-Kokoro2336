...
#[allow(unused)]
/// Get the base address of the temporary kernel mapping for a given id.
pub fn get_tempo_kernel_map_base(id: usize) -> VirtAddr {
    VirtAddr::from(crate::config::TEMP_KERNEL_MAP_BASE + id * 2 * PAGE_SIZE)
}